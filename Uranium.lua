...
ImageButton.Image = "http://www.roblox.com/asset/?id=12194477043"
...
function library:AddWindow(text,keybind)
    ...
    NameHub2.Text = "        HUB x Premium 1.0"
...
Main10:AddToggle("Auto Farm Monster Raid",_G.AutoFarmNear,function(value)
        _G.AutoFarmNear = value
        StopTween(_G.AutoFarmNear)
    end)
...
Main10:AddButton("Next Island",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
